...
@router.callback_query(F.data == "cmd:achievements")
...
@router.callback_query(F.data == "cmd:referral")
...
@router.callback_query(F.data == "cmd:payout")
...
@router.callback_query(F.data == "cmd:support")
